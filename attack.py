...
if __name__ == "__main__":
    ...
    commandLineParser.add_argument('--model_name', type=str, required=True, help='e.g. roberta-large')
    ...
    commandLineParser.add_argument('--prompt_finetune', action='store_true', help='whether to use prompt finetuning')
